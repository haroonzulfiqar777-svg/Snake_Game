...
# Fallback for environments where __file__ is undefined
try:
    SCRIPT_DIR = Path(__file__).parent
except NameError:
    SCRIPT_DIR = Path.cwd()

HIGH_SCORE_FILE = SCRIPT_DIR / "high_score.json"  # save file location
...
class Board:
    ...
    def random_empty_cell(self) -> Point:
        empty_coords = np.argwhere(self.grid == EMPTY)
...
def main() -> None:
    ...
    def new_game() -> tuple[Snake, Point]:
        ...
        board.rebuild_from_snake_and_food(snake.body, start)
